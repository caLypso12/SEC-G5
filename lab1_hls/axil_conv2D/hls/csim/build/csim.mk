...
HLS_SOURCES = ../../../../../lab1_prof/hls/tb_axil_conv2D.cpp ../../../../../lab1_prof/hls/axil_conv2D.cpp
...
$(ObjDir)/tb_axil_conv2D.o: ../../../../../lab1_prof/hls/tb_axil_conv2D.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../lab1_prof/hls/tb_axil_conv2D.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/tb_axil_conv2D.d

$(ObjDir)/axil_conv2D.o: ../../../../../lab1_prof/hls/axil_conv2D.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../lab1_prof/hls/axil_conv2D.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
