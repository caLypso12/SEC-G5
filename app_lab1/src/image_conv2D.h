...
#define CONV2D_BASEADDR 0x40000000
#define XAXIL_CONV2D_BUS1_ADDR_IMAGE_IN_DATA 0x2000
#define XAXIL_CONV2D_BUS1_ADDR_IMAGE_OUT_DATA 0x4000
#define XAXIL_CONV2D_BUS1_ADDR_WEIGHTS_DATA 0x0010
...
#define MEM_DATA_HW_BASE_ADDRESS 0x12000000
#else
